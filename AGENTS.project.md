...
Phone-first PWA. First screen is the porch. Bottom bar: Today · Inspect · Home. Home holds setup (bar + Tell Roofus + Presets links). Footer above it: Back · Help · Menu. Back only on Cards, Reference, Presets, Streets, and Storms. Menu: Cards, Reference, Streets, Storms, Presets. Streets, mindset, and reminders live in Presets. Reminders nag on open: morning storm (opens Storms), evening journal, Sundays pace, the 1st stack — only if that box is empty. No lock-screen.
