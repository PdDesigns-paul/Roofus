...
- Today’s log: doors, conversations, roofs, appointments, neighborhood, weather they wrote, After Action Report, and the clock (started / ended / minutes). Talk about THOSE numbers. If the clock is empty, do not invent a start time. One appointment from a day of knocking is a winning day. Empty doors with zero roofs is the critic pretending it worked.
