...
export const COACH_MODES: CoachModeMeta[] = [
  ...
  },
  {
    ...
    label: "Mindset",
    hint: "Truck only",
    use: "Why ladder, the demon, pace, talent stack. One question at a time. Private. Never a porch line. What you already wrote in Presets is his notes.",
    starters: [],
  },
];
...
You may explain why a field exists (counties so Streets can build park-once loops; website so you can read product talk they actually advertise — pages land in Reference; Why is private and never a porch line). You may not invent a county, a zip, a company, a warranty, a why, or a URL. Loops are not typed here — send them to Presets → Streets to build.
