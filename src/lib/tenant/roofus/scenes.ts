/** Pack `roofus` Roleplay beats and who-chips. Kernel Score me / Hear it stay in coach-modes. */
import type { RoleplayScene, RoleplayWho } from "../pack.ts";

export const ROOFUS_SCENES: RoleplayScene[] = [
  {
    id: "walkup",
    label: "Walk-up",
    hint: "First 30 seconds",
    knockLine: "[who]. Walk-up. I knock.",
...
Storm talk (Script A) only if a real logged storm hit that street. Do not invent hail to finish “what’s been going on.” SLAP in his head: say hi, let them know why you stopped, ask one open question, present only to their answer. If the door is closing: “I’ll cut right to the chase,” then the L. Stay the homeowner. Short. Real. End this beat at a ladder yes, or a name on a no.`,
  },
  {
    ...
    hint: "After Keep",
    claim: true,
    knockLine: "[who] Kept storm on this zip. I ask the claim-stage question.",
...
Score me extras: truth (no invented storm, no “every carrier pays,” no flip promise); one stage only; deductible asked before they pitch a claim; document first; name even on a no; next physical step.`,
  ...
  },
  {
    ...
    label: "After photos",
    hint: "i35 talk",
    knockLine: "[who]. Look is done. I already showed them photos. I start i35. No pictures in this chat.",
  ...
  },
  {
    ...
    knockLine: "[who]. Look is done. We walk the house. I ask buying questions.",
...
Score me extras: cut if they pitch a number, ask WHY, skip to a signature, talk only on the porch, ignore “who else has to see a number.” Keep if they ask one open question at a time, restate a constraint, book Set as the next step.`,
  },
  {
    ...
    label: "The set",
    hint: "Next yes",
    knockLine: "[who]. Look is done. I am setting morning or afternoon.",
  ...
  },
  {
    ...
    label: "Phone review",
    hint: "After photos",
    knockLine: "[who]. Photos already happened. This is the 20–30 min phone review. I answer the phone.",
...
Score me extras: cut if they invent damage, close without the other name, promise the carrier, send a fake text, skip “can you see what I showed you.” Keep if they get both names, three options from agreed photos, admission that a claim can be denied, a dated next step.`,
  },
  {
    ...
    label: "Whole visit",
    hint: "Knock to set",
    knockLine: "[who]. Whole visit from the knock. I knock.",
...
export const ROOFUS_WHO: RoleplayWho[] = [
...
export const ROOFUS_CLAIM_STAGES: RoleplayWho[] = [
