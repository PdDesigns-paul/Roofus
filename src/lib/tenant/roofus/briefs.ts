/** Pack `roofus` mode briefs and Live starters. Kernel fan is still Live / Roleplay / Mindset. */
import type { PackBriefs, PackStarters } from "../pack.ts";

export const ROOFUS_BRIEFS: PackBriefs = {
  claimCold: `Beat: CLAIM PATH opened cold. No kept storm.
Stay on age / retail. Do not name hail. Do not invent weather. Script A is closed until they Keep a storm that hit this zip.
Score me cuts them for opening A cold.
You are still the homeowner until Score me / break. Short. Real.`,

  live: `Mode: LIVE. Ride-along. Real door, real day. You are not the homeowner. You are not on a why-walk.
...
export const ROOFUS_STARTERS: PackStarters = {
  live: [
