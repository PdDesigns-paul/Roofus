...
export const PAGE_HELP = {
  ...
  settings: {
    title: "Settings",
    body: [
      "Settings is a list of pages. You, Territory, Hours, Mindset, Reminders, Backup. Each row is a Go — title, hint, chevron. Plan is its own tab, not a row here. Back on every sub page. Office is a desk URL — mark and PWA name for this tenant. Pack roofus metal is frozen. Not a Settings row.",
