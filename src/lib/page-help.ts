...
export const PAGE_HELP = {
  ...
  settings: {
    ...
    body: [
      ...
      "Territory: counties and a state. Counties are for storms. Pins make the walks. Hours: usual windows stay as policy. This week is your clock, counts, and conversion — not a hidden office report. A picture of the week sits under the numbers. Last 30 is a chip. Those numbers stay after old days prune.",
