export const PAGE_HELP = {
  home: {
    title: "Roofus",
    body: [
      "Bottom: Truck, Door, Roof, Prep. Setup lives in Settings — name, company, counties. Tell Roofus writes those fields. Truck is the field log.",
  ...
  mindset: {
    ...
    body: [
      ...
      "Why is a ladder: number, what it buys, who else, the person or promise. Read it with Roofus on a dead day. Demon names the attack. Pace drops a gear. Stack is three skills. After Action Report lives on Prep — wins, facts, a plan.",
