...
export const REMINDERS = [
  {
    ...
    hint: "The card in Settings. Not a nag.",
    to: "/settings",
  },
  {
    id: "storm",
    label: "Storm report",
    when: "Morning",
    hint: "Last 48 hours on Prep. Only if you open before noon and it is empty.",
    to: "/after",
    hash: "pulse",
  },
  {
    ...
    when: "Evening",
    hint: "After Action Report on Prep. After 5, if it is blank.",
    to: "/after",
    hash: "finish",
  },
  {
    ...
    label: "Weekly pace",
    when: "Sundays",
    hint: "Gear and one off-block. Settings → Mindset.",
    to: "/settings/mindset",
  },
  {
    id: "stack",
