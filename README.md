...
| Surface | What it is |
| --- | --- |
| **Truck** | Pre-knock strip, four counts (a log, not a quota), process-day chips (Left on time · Working loop set · AAR written · Tomorrow picked; Look / Set are bonus), neighborhood (several park-once loops), weather you may mention, After Action Report (wins / do-better / plan), tomorrow. Cards in the strip opens Door. Empty-book setup if the profile is blank. |
